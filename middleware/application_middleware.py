...
async def auth_package_middleware(request: Request) -> Dict[str, Any]:
    ...
    Generated from middleware ID: mid_00c37d0dc0514d08b20e4bb872aa56f8
    """
    try:
        ...
        public_paths = [
            ...
            "/mayson/auth/magic/email/login",
            "/mayson/auth/magic/mobile/login",
            "/mayson/auth/magic/verify",
        ...
        auth_package_secret_key = """Wj5gZaTahu878xWqxlOLyru73IzaM38rmAm2IWZnbgo="""
...
async def cors_middleware(request: Request) -> Dict[str, Any]:
    """
    CORS Middleware
    Generated from middleware ID: mid_ebbbd9809b494b008d2e66f3cf299d7a
    """
    try:
